                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <%
	                                ...
	                                for(Admin a : daoa.All())
	                                {
	                                	if(request.getParameter("op") != null && request.getParameter("op").equals("modiferAdmin"))
	                                	{
	                                			int idAdmin = Integer.parseInt(request.getParameter("idAdmin"));
	                                			if(idAdmin == a.getId())
	                                			{
	                                				%>
	    	                                		<form action="../directeurs" method="post">
		    	                                		<tr>
		    	                                			
		    			                                    <th><input type="text" name="nom" value="<%=a.getNom() %>"></th>
		    			                                    <th><input type="text" name="prenom" value="<%=a.getPrenom() %>"></th>
		    			                                    <th><input type="number" name="age" value="<%=a.getAge() %>"></th>
		    			                                    <th><input type="text" name="genre" value="<%=a.getGenre() %>"></th>
		    			                                    <th><input type="text" name="gmail" value="<%=a.getGmail() %>"></th>
		    			                                    <th><input type="text" name="tele" value="<%=a.getTele() %>"></th>
		    			                                    <th><input type="text" name="login" value="<%=a.getLogin() %>"></th>
		    			                                    <th><input type="text" name="pass" value="<%=a.getPass() %>"></th>
		    			                                    <th>id = <input type="number" name="id" readonly="readonly" value="<%=a.getId() %>"></th>
		    			                                    <th><input type="submit" name="modiferAdmin" value="    Save     "></th>
		    			                                </tr>
	    	                                		</form>
	    	                                	    <%
	                                			}else
	                                			{
	    	                                		...
	    	                                		<tr>
	    			                                    ...
	    			                                    <th><%=a.getPass() %></th>
	    			                                    <td>
	    			                                        <a href="?op=modiferAdmin&idAdmin=<%=a.getId() %>" class="btn btn-primary">Modifier</a>			                                        
	    			                                    </td>
	    			                                    <td><a href="../directeurs?op=supprimerAdmin&idAdmin=<%=a.getId() %>" class="btn btn-primary">Supprimer</a></td>
	    			                                </tr>
	    	                                	    <%
	                                			}
	                                	}else
	                                		...
	                                		<tfoot>
									             <form action="../directeurs" method="post">
										             <tr>
												        ...
												        <th colspan="3"><input type="submit" name="ajouterAdmin" value="Ajouter" class="btn btn-primary"></th>							                                    
												    </tr>
									             </form>
									        </tfoot>
	                                	<%
