    	...
    	if(session.getAttribute("dir") != null)
    	{
    			...
    			for(Contact c : daoc.All())
    			{
    				...
    				<!--  Table Debut -->   				 						  
						    ...
						    <li class="table-row">
						      <div class="col col-1" data-label="Job Id"><%=c.getName() %></div>
						      <div class="col col-2" data-label="Customer Name"><%=c.getEmail() %></div>
						      <div class="col col-3" data-label="Amount"><%=c.getSubject() %></div>
						      <div class="col col-4" data-label="Payment Status"><%=c.getMessage() %></div>
						    </li>
					<!--  Table Fin -->
    				<%
    			}
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <%
                    	...
                    	{
                    %>
                    	<h1><%=request.getParameter("response")%></h1>
                    <% 
                    	}
                    %>
                        <div class="row g-3">
